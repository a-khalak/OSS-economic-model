function [P,Q] = ecs (w, u, cb, corp, initial_scheme); 
...
if k1 <= max([corp.memory]),

% until memory is built up, use the 2 step.
for k3 = 1:M,
  P(k3,k1+1) = comp_model2 (Q(k3,k1),Q(k3,k1-1),P(k3,k1),P(k3,k1-1), ...
      corp.alpha(k3), corp.limit(k3));
end;     

else,

for k3 = 1:M,
krange = k1-corp.memory:k1;
    P(k3,k1+1) = ...
          comp_model3 (Q(k3,krange),P(k3,krange), corp.alpha(k3), corp.limit(k3));
end;
